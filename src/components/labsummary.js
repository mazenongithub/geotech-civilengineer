        ...
        if (project) {
            ...
            if (borings) {
                ...
                borings.map(boring => {
                    ...
                    const samples = geotech.getSamplesByBoringId.call(this, projectid, boringid)
                    if (samples) {
                        // eslint-disable-next-line 
                        samples.map(sample => {
                            ...
                            const unconfined = geotech.getUnconfinedTestById.call(this, projectid, boringid, sampleid);
                            ...
                            const sieve = geotech.getSieveBySampleId.call(this, projectid, boringid, sampleid)
        ...
        if (project) {
            ...
            return (<div style={{ ...styles.generalContainer }}>
                ...
                <div style={{ ...styles.generalContainer, ...styles.alignCenter, ...styles.bottomMargin15 }}>
                    <Link
                        style={{ ...styles.generalFont, ...headerFont, ...styles.generalLink, ...styles.boldFont }}
                        to={`/projects/${user.clientid}/${project.projectid}/labsummary`}>
                        /LabSummary
                    </Link>
                </div>
